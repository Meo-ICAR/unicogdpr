...
class Audit extends Model
{
    ...
    /**
     * Gap analysis della checklist documentale di audit: una riga per ogni
     * voce del catalogo AuditChecklistItem valutata per questo audit.
     */
    public function checklistEvaluations(): HasMany
    {
