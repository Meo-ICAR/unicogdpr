...
class ModelFieldIntrospector
{
    ...
    private function columnsForClass(string $modelClass): array
    {
        ...
        // Alcune tabelle potrebbero essere qualificate con lo schema; qui ci
        // serve solo il nome della tabella senza prefisso per interrogare
        // information_schema.
     ...
     * identificato dalla sua `owner_key` (non necessariamente 'id').
     *
