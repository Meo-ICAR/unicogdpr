...
if (! function_exists('resolveUserEmployeeTypeIds')) {
     ...
     *
     * Il profilo viene risolto tramite User::profile() (morphTo, come in
     * unicobpm), oppure tramite User::employee() se presente sul modello
     * (gestisce sia una relazione singola che una HasMany, prendendo in tal
     * caso il primo Employee collegato).
     */
